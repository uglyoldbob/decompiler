...
std::shared_ptr<ObjectMapper> DummyObjectMapper::examine_object_fail(std::shared_ptr<QDataStream> str)
{
    return std::shared_ptr<ObjectMapper>(nullptr);
}


std::shared_ptr<ObjectMapper> DummyObjectMapper::examine_object_succeed(std::shared_ptr<QDataStream> str)
{
