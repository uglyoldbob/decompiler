...
void DecompileProject::add_object(QString filename, QString rel_name)
{
    QString output_name = project_directory + QString("/") + rel_name;
...
void DecompileProject::add_object(QString filename)
{
    QString output_name = QString("./") + QFile(filename).fileName();
    add_object(filename, output_name);
}
